...
%\bibliography{mabiblio} % mon fichier de base de données s'appelle mabibli.bib
%\includegraphics[2]{bibliography.pdf}
%\includepdf[]{bibliography.pdf}
	\include{Partie6}
...
%ma bibliografy \cite{ref}
  %\includepdf[2]{bibliography.pdf}
